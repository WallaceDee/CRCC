...
export const device = () => {
  ...
  let iphoneX =
    iphone && window.screen.width === 375 && window.screen.height === 812
  // Windows
  if (windows) {
    device.os = 'windows'
...
export const initWebp = function() {
  return new Promise((resolve) => {
    ...
    const onload = function(event) {
      isSupportWebp =
        event && event.type === 'load' ? testImage.width === 1 : false
...
export const getOAuth2Code = function() {
  ...
  const state =
    '73c118cd574253aeb762794a1e3473379838152b868e881344d7c3ee9f35f706'
  let jumpUrl = `${OAUTH2_URL}?client_id=174&redirect_uri=${currentHref}&state=${state}&scope=read&response_type=code`

      ...
      <Row style="height:100%;">
        <Col style="height:100%;overflow:auto;" class="nav">
          <Menu
            ...
            style="height:100%;"
          >
            <MenuItem name="Index"> <Icon type="ios-home" />首页 </MenuItem>
            <MenuItem name="Monitor">
              <Icon type="md-images" />列车监控
            </MenuItem>
            <MenuItem name="Statistics">
              <Icon type="md-images" />故障统计
            </MenuItem>
            <MenuItem name="List"> <Icon type="md-images" />故障查询 </MenuItem>
          </Menu>
        </Col>
        <Col class="body">
          <router-view />
